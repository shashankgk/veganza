  ...
  <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="index.html"><span class="logo_colour">A Secured Data Deduplication in Cloud Storage</span></a></h1>
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="eligibleFiles.jsp">Download</a></li>
          <li><a href="fileList.jsp">Share</a></li>
...
if(session.getAttribute("LoginID")==null)
{
	...
	out.print("<li><a href='logout.jsp'>Logout</a></li>");
        out.print("<li><a href='logout.jsp'>&nbsp;</a></li>");
        out.print("<li><a href='logout.jsp'>&nbsp;</a></li>");
        out.print("<li><a href='#'>"+session.getAttribute("UserName")+"</a></li>");
}
%>
